      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-col items-center justify-center h-64 gap-4">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-[var(--muted-foreground)]">
                Deploy the VPS agent to start monitoring
              </p>
            </div>
          </div>
        ) : (
        ...
        <div className="mt-12 bg-[var(--card)] border border-[var(--border)] rounded-lg p-6">
          ...
          <p className="text-xs text-[var(--muted-foreground)] mb-4">
            Run the monitoring agent on your VPS to start collecting metrics:
          </p>
          <div className="bg-[var(--background)] border border-[var(--border)] rounded-lg p-4 font-mono text-xs text-[var(--muted-foreground)] overflow-x-auto">
            <pre>{`# Download and run the VPS monitor agent
